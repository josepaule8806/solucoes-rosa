...
const differentials = [
  ...
  { icon: MapPin, title: "Atendimento em Porto Alegre e Região", description: "Cobertura em Porto Alegre e toda a região metropolitana." },, title: "Atendimento em Porto Alegre e Região", description: "Cobertura em Porto Alegre e toda a região metropolitana." }," },
