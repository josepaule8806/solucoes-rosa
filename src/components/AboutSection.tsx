        ...
        <div className="grid gap-12 md:grid-cols-2 items-center">
          <div>
            ...
            <p className="mb-4 text-muted-foreground leading-relaxed">
              A <strong className="text-foreground">Soluções Rosa</strong> nasceu com a missão de oferecer serviços profissionais de alta qualidade para empresas e residências. Com uma equipe altamente qualificada, garantimos soluções eficientes e um atendimento personalizado.
            </p>
